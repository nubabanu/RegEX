...
public class RedundancyAnalyzerTest {
    ...
    void setUp() {
        ...
        story1.setPersona(List.of("Visitor"));
        ...
        story2.setPersona(List.of("Visitor"));
        ...
        story3.setPersona(List.of("Administrator"));
        ...
        story4.setPersona(List.of("Administrator"));
        ...
        story5.setPersona(List.of("User"));
